...
- **Styling:** Bootstrap, CSS, JavaScript  
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/rubyconf_home.png" title="RubyConf Africa Homepage" class="img-fluid rounded z-depth-1" %}
  </div>
